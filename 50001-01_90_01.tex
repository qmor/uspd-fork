...
%end of variables
\renewcommand{\additionallapprove}
{
	& & Начальник отдела 11 \\ && \signfield{Д.Одиноков} \\ && \datefield \\ \\
	& & Начальник отдела 22 \\ && \signfield{В.Двубоков} \\ && \datefield \\ \\
	& & Начальник отдела 33 \\ && \signfield{A.Троероков} \\ && \datefield \\ \\
}
